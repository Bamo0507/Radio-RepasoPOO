...
public class App {
    ...
    static boolean continueRadio = true;
        ...
        while (true) {
            ...
            if (mainOpcion == 1) {
                ...
                while (continueRadio) {
                    ...
                    System.out.println("5. Modificar el volumen");
            ...
            } else if (mainOpcion == 2) {
                System.out.println("Gracias por usar nuestra radio. ¡Hasta pronto!");
                break;

                 // Add this line to exit the while loop after accessing the menu method
            }else {
                System.out.println("Por favor, ingrese una de las dos opciones válidas.");
